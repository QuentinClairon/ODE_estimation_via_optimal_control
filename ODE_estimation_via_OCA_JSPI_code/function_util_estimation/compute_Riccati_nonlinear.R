compute_Riccati_nonlinear <- function(Times_integ,pseudo_Y,State_i_m1,param_struct,mat_U,mat_A,mat_B,mat_C,weight_integ){
  ############################################################
  # DESCRIPTION: compute the Riccati  solution at a given iteration l of the algorithm described in section 3.3 when estimating CI and for nonlinear ODE models
  # 
  # FUNCTION SIGNATURE:  compute_Riccati_nonlinear <- function(Times_integ,pseudo_Y,State_i_m1,param_struct,mat_U,mat_A,mat_C,mat_B,weight_integ)
  # 
  # INPUT :
