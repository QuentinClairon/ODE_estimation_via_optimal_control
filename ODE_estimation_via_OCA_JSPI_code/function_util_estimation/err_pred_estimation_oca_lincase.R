err_pred_estimation_oca_lincase <- function(Times_integ,pseudo_Y,est_param,State_opt,mat_U,mat_A,mat_B,mat_C,weight_integ){
  ############################################################
  # DESCRIPTION: Compute the prediction error according to the formula given in section 5 and for linear ODE models
  # 
  # FUNCTION SIGNATURE:  err_pred_estimation_oca_lincase <- function(Times_integ,pseudo_Y,est_param,State_opt,mat_U,mat_A,mat_B,mat_C,weight_integ)
  # 
  # INPUT :
