est_param_iter_oca_linear_profiled_ic <- function(Times_obs,Yn,param_ini,mat_U,mat_A,mat_B,mat_C,mesh_mult=1,x0_known = c()){
  ############################################################
  # DESCRIPTION: compute the parameter estimation  when profiling on IC and for linear ODE models
  # 
  # FUNCTION SIGNATURE:  est_param_iter_oca_linear_profiled_ic <- function(Times_obs,Yn,param_ini,mat_U,mat_A,mat_B,mat_C,mesh_mult=1,x0_known = c())
  # 
  # INPUT :
